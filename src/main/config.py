...
FIRST_FILL_COLOR = '#dae8fc'                # FIRST = main system, the system that drives the direction (inbound/outbound) 
...
FIRST_STROKE_COLOR  = '#6c8ebf'             # FIRST = main system, the system that drives the direction (inbound/outbound) 
...
APP_TYPES = ['sap_app', 'middleware', 'gateway', 'other_middleware', 'connected_app']   # Types of applications in scope to the diagrams